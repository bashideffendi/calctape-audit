...
export default function ManualPage() {
  ...
  return (
    <div className="min-h-screen bg-[#f0f2f5]">
      ...
      <header className="bg-white border-b border-gray-200 sticky top-0 z-50 print:hidden">
        <div className="max-w-7xl mx-auto px-3 py-2 flex items-center justify-between">
          ...
          <div className="flex items-center gap-1">
            ...
            <button
              onClick={exportCSV}
              className="btn-sm bg-green-50 text-green-600 hover:bg-green-100"
            >
              Export
            </button>
            <button
              onClick={() => window.print()}
              className="btn-sm bg-gray-50 text-gray-600 hover:bg-gray-100"
            >
              Print
            </button>
            <button
              onClick={saveAll}
              className="btn-sm bg-purple-50 text-purple-600 hover:bg-purple-100"
              title="Simpan (Ctrl+S)"
            >
              Simpan
            </button>
        ...
        <div className="max-w-7xl mx-auto px-3 pb-2">
          <div className="tab-bar">
            <button
              onClick={newSession}
              className="btn-sm bg-gray-100 text-gray-500 hover:bg-gray-200 mr-1"
              title="Sesi Baru"
            >
              +
            </button>
      ...
      {/* Toast */}
      {toast && (
        <div className="fixed bottom-4 right-4 bg-blue-600 text-white text-sm font-semibold px-4 py-2 rounded-xl shadow-lg z-50">
          {toast}
        </div>
      )}
    </div>
