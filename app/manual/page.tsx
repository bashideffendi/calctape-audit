...
export default function ManualPage() {
  ...
  return (
    <div className="min-h-screen bg-slate-50">
      ...
      <header className="bg-white border-b border-slate-200 sticky top-0 z-50 print:hidden">
        <div className="max-w-7xl mx-auto px-4 h-12 flex items-center justify-between">
          <div className="flex items-baseline gap-2">
            ...
            <span className="text-[11px] text-slate-400">Tape Manual</span>
          </div>
          <div className="flex items-center gap-1">
            <button
              onClick={addColumn}
              className="btn-sm bg-slate-100 text-slate-700 hover:bg-slate-200"
            >
              + Kolom
            </button>
            <button
        ...
        <div className="max-w-7xl mx-auto px-3 pb-2">
          <div className="tab-bar">
            <button
              onClick={newSession}
              className="btn-sm bg-slate-100 text-slate-500 hover:bg-slate-200 mr-1"
              title="Sesi Baru"
            >
              +
            </button>
                      ...
                      return col.rows.map((r, ri) => {
                          ...
                          return (
                            <div key={ri} className="tape-row subtotal-row">
                              ...
                              <button
                                ...
                                className="text-gray-300 hover:text-red-400 ml-1 text-xs print:hidden"
                              >
                                ×
                              </button>
                            </div>
                        ...
                        return (
                          <div key={ri} className="tape-row">
                            ...
                            <button
                              onClick={() => deleteRow(ci, ri)}
                              className="text-gray-200 hover:text-red-400 ml-1 text-xs print:hidden"
                            >
                              ×
                            </button>
                          </div>
                ...
                <div className="tape-input-area">
                  ...
                  <div className="flex justify-between mt-1">
                    ...
                    <button
                      ...
                      className="text-[10px] text-slate-600 font-semibold hover:text-slate-900"
                    >
                      Subtotal
                    </button>
                  </div>
      ...
      {/* Toast */}
      {toast && (
        <div className="fixed bottom-4 right-4 bg-slate-900 text-white text-sm font-semibold px-4 py-2 rounded-xl shadow-lg z-50">
          {toast}
        </div>
      )}
    </div>
